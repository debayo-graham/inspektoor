...
import 'edit_asset_page_copy_model.dart';
export 'edit_asset_page_copy_model.dart';

class EditAssetPageCopyWidget extends StatefulWidget {
  const EditAssetPageCopyWidget({
    super.key,
  ...
  static String routeName = 'EditAssetPageCopy';
  static String routePath = '/editAssetPageCopy';

  @override
  State<EditAssetPageCopyWidget> createState() =>
      _EditAssetPageCopyWidgetState();
}

class _EditAssetPageCopyWidgetState extends State<EditAssetPageCopyWidget> {
  late EditAssetPageCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditAssetPageCopyModel());
                ...
                children: [
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              ...
                              if (selectedMedia != null &&
                                ...
                                safeSetState(() => _model
                                    .isDataUploading_uploadData5jf1 = true);
                                ...
                                try {
                                  ...
                                  _model.isDataUploading_uploadData5jf1 = false;
                                }
                                if (selectedUploadedFiles.length ==
                                    selectedMedia.length) {
                                  safeSetState(() {
                                    _model.uploadedLocalFile_uploadData5jf1 =
                                ...
                                children: [
                                  Align(
                                    ...
                                    child: Container(
                                      ...
                                      child: Builder(
                                        builder: (context) {
                                          if (_model.uploadedLocalFile_uploadData5jf1 !=
                                                  null &&
                                              (_model.uploadedLocalFile_uploadData5jf1
                                                      .bytes?.isNotEmpty ??
                                                  false)) {
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        if (_model.uploadedLocalFile_uploadData5jf1 != null &&
                            (_model.uploadedLocalFile_uploadData5jf1.bytes
                                    ?.isNotEmpty ??
                                false)) {
                          {
                            safeSetState(() =>
                                _model.isDataUploading_uploadDataNqy1 = true);
                            var selectedUploadedFiles = <FFUploadedFile>[];
                            var selectedMedia = <SelectedFile>[];
                            var downloadUrls = <String>[];
                            try {
                              selectedUploadedFiles = _model
                                      .uploadedLocalFile_uploadData5jf1
                                      .bytes!
                                      .isNotEmpty
                                  ? [_model.uploadedLocalFile_uploadData5jf1]
                                  : <FFUploadedFile>[];
                              ...
                              _model.isDataUploading_uploadDataNqy1 = false;
                            }
                            if (selectedUploadedFiles.length ==
                                    selectedMedia.length &&
                                downloadUrls.length == selectedMedia.length) {
                              safeSetState(() {
                                _model.uploadedLocalFile_uploadDataNqy1 =
                                    selectedUploadedFiles.first;
                                _model.uploadedFileUrl_uploadDataNqy1 =
                                    downloadUrls.first;
                              });
                            } else {
                              safeSetState(() {});
                          ...
                          if (widget!.assetRow?.picUrl != null &&
                              widget!.assetRow?.picUrl != '') {
                          ...
                          await AssetsTable().update(
                            data: {
                              ...
                              'picUrl': _model.uploadedFileUrl_uploadDataNqy1,
                            },
