...
import 'create_inspection_form_page_model.dart';
export 'create_inspection_form_page_model.dart';

class CreateInspectionFormPageWidget extends StatefulWidget {
  const CreateInspectionFormPageWidget({super.key});

  static String routeName = 'CreateInspectionFormPage';
  static String routePath = '/createInspectionFormPage';

  @override
  State<CreateInspectionFormPageWidget> createState() =>
      _CreateInspectionFormPageWidgetState();
}

class _CreateInspectionFormPageWidgetState
    extends State<CreateInspectionFormPageWidget>
    with TickerProviderStateMixin {
  late CreateInspectionFormPageModel _model;
                                                      ...
                                                      children: [
                                                        ...
                                                        InkWell(
                                                          ...
                                                          onTap: () async {
                                                            ...
                                                            _model.inspectionFormItems = _model
                                                                .inspectionFormItemsAfterDelete!
                                                                .toList()
                                                                .cast<
                                                                    dynamic>();
                                                            safeSetState(() {});
