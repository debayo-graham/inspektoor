...
import 'edit_inspection_form_page_widget.dart'
    show EditInspectionFormPageWidget;
...
class EditInspectionFormPageModel
    extends FlutterFlowModel<EditInspectionFormPageWidget> {
  ...
  bool showFormActions = false;

  bool isShowPreviewBtn = false;

  bool isShowDuplicateBtn = false;

  bool isShowDeleteBtn = true;

  ///  State fields for stateful widgets in this page.

  // Stores action output result for [Custom Action - unwrapSchema] action in EditInspectionFormPage widget.
  List<dynamic>? unwrappedSchema;
  ...
  // Stores action output result for [Backend Call - Update Row(s)] action in Button1 widget.
  List<InspectionTemplatesRow>? updateTemplate;
