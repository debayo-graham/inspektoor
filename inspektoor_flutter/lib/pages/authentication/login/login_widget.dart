                                      ...
                                      children: [
                                        ...
                                        wrapWithModel(
                                          ...
                                          child: ButtonMainWidget(
                                            buttonText: 'Sign In',
                                            disableButton: (_model.emailState
                                                    ? false
                                                    : true) ||
                                                (_model.passwordState
                                                    ? false
                                            ...
                                            action: () async {
                                              ...
                                              _model.loginState = getJsonField(
                                                _model.loginResults,
                                                r'''$.success''',
                                              );
                                              safeSetState(() {});
                                              if (_model.loginState) {
                                                FFAppState().snackbarMsg =
                                                    getJsonField(
                                                  _model.loginResults,
                                                  r'''$.message''',
                                                ).toString();
                                                FFAppState().snackbarColor =
                                                    FlutterFlowTheme.of(context)
                                                        .success;
                                                FFAppState().showSnackbar =
                                                    true;
                                                FFAppState().update(() {});
