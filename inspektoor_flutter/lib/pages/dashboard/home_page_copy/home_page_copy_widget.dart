  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<AppUsersRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<AppUsersRow> homePageCopyAppUsersRowList = snapshot.data!;

        final homePageCopyAppUsersRow = homePageCopyAppUsersRowList.isNotEmpty
            ? homePageCopyAppUsersRowList.first
            : null;
